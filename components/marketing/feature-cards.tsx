...
const features = [
  {
    ...
    description: 'See who is compliant, who is nearing limits, and what to approve next from one record.',
    outcome: 'Team-wide Schengen visibility',
  ...
  },
  {
    ...
    description: 'Add one trip and every allowance updates instantly across the full window.',
    outcome: 'Formula-free day calculations',
  ...
  },
  {
    ...
    description: 'Green, amber, and red status highlights risk early enough to replan with confidence.',
    outcome: 'Compliance decisions earlier',
  ...
  },
  {
    ...
    description: 'Import spreadsheets or log trips manually, then keep everything in one auditable timeline.',
    outcome: 'Single Schengen system of record',
