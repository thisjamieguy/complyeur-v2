...
describe('CalendarView', () => {
  ...
  it('marks past days as historical while keeping planning risk for today and future dates', () => {
    ...
    // 2026-03-21 reaches exactly 90 days used: exhausted (red, 0 remaining) but
    // NOT a breach. Breach requires exceeding 90 — see lib/compliance and
    // commit ca4af0c "treat day 90 as exhausted".
