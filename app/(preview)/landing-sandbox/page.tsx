...
export const metadata: Metadata = {
  title: 'Landing Sandbox | ComplyEur',
  robots: {
    index: false,
    follow: false,
  },
  ...
  return (
    <div className="landing-shell landing-font relative min-h-screen overflow-x-hidden bg-[color:var(--landing-surface)] text-slate-900">
      ...
      <main id="main-content" className="relative z-10">
        ...
        <section id="request-access" className="px-4 py-16 sm:px-6 lg:py-20">
          <div className="mx-auto grid max-w-7xl gap-8 rounded-xl border border-brand-200/80 bg-[linear-gradient(135deg,rgba(240,244,248,0.96),rgba(220,228,237,0.86))] p-6 shadow-sm lg:grid-cols-[minmax(0,1fr)_26rem] lg:items-center lg:p-8">
            <div>
              <SectionLabel>Request access</SectionLabel>
              <h2 className="mt-4 max-w-2xl text-balance text-3xl font-semibold leading-tight text-slate-900 sm:text-4xl">
