...
const actionConfig: Record<string, { icon: LucideIcon; color: string; label: string; bgColor: string }> = {
  ...
  'tier.created': { icon: FileEdit, color: 'text-green-600', bgColor: 'bg-green-50', label: 'Created tier' },
  'tier.updated': { icon: FileEdit, color: 'text-blue-600', bgColor: 'bg-blue-50', label: 'Updated tier' },
  'tier.archived': { icon: FileEdit, color: 'text-amber-600', bgColor: 'bg-amber-50', label: 'Archived tier' },
  'tier.restored': { icon: FileEdit, color: 'text-green-600', bgColor: 'bg-green-50', label: 'Restored tier' },
  'tier.deleted': { icon: FileEdit, color: 'text-red-600', bgColor: 'bg-red-50', label: 'Deleted tier' },
