...
- The central MFA policy requires MFA for `owner`, `admin`, and superadmin users in [`lib/security/mfa.ts:26`](../../lib/security/mfa.ts#L26) and [`lib/security/mfa.ts:62`](../../lib/security/mfa.ts#L62).
- The dashboard layout enforces that policy during page rendering in [`app/(dashboard)/layout.tsx:22`](<../../app/(dashboard)/layout.tsx#L22>).
...
- Team management mutations in [`app/(dashboard)/settings/team/actions.ts:233`](<../../app/(dashboard)/settings/team/actions.ts#L233>), [`app/(dashboard)/settings/team/actions.ts:323`](<../../app/(dashboard)/settings/team/actions.ts#L323>), [`app/(dashboard)/settings/team/actions.ts:383`](<../../app/(dashboard)/settings/team/actions.ts#L383>), [`app/(dashboard)/settings/team/actions.ts:445`](<../../app/(dashboard)/settings/team/actions.ts#L445>), [`app/(dashboard)/settings/team/actions.ts:494`](<../../app/(dashboard)/settings/team/actions.ts#L494>)
- Company settings mutation in [`lib/actions/settings.ts:63`](../../lib/actions/settings.ts#L63)
- GDPR destructive actions delegated through [`app/(dashboard)/gdpr/actions.ts:188`](<../../app/(dashboard)/gdpr/actions.ts#L188>), [`app/(dashboard)/gdpr/actions.ts:226`](<../../app/(dashboard)/gdpr/actions.ts#L226>), [`app/(dashboard)/gdpr/actions.ts:268`](<../../app/(dashboard)/gdpr/actions.ts#L268>), with underlying helpers in [`lib/gdpr/soft-delete.ts:68`](../../lib/gdpr/soft-delete.ts#L68), [`lib/gdpr/soft-delete.ts:238`](../../lib/gdpr/soft-delete.ts#L238), [`lib/gdpr/anonymize.ts:80`](../../lib/gdpr/anonymize.ts#L80)
- Bulk delete path using the service-role client in [`lib/actions/bulk-delete.ts:276`](../../lib/actions/bulk-delete.ts#L276)
...
- The codebase already uses `checkServerActionRateLimit()` for some sensitive actions, for example DSAR export in [`app/(dashboard)/gdpr/actions.ts:100`](<../../app/(dashboard)/gdpr/actions.ts#L100>) and team invites in [`app/(dashboard)/settings/team/actions.ts:241`](<../../app/(dashboard)/settings/team/actions.ts#L241>).
...
- [`app/(dashboard)/settings/team/actions.ts:323`](<../../app/(dashboard)/settings/team/actions.ts#L323>)
- [`app/(dashboard)/settings/team/actions.ts:383`](<../../app/(dashboard)/settings/team/actions.ts#L383>)
- [`app/(dashboard)/settings/team/actions.ts:445`](<../../app/(dashboard)/settings/team/actions.ts#L445>)
- [`app/(dashboard)/settings/team/actions.ts:494`](<../../app/(dashboard)/settings/team/actions.ts#L494>)
- [`lib/actions/settings.ts:63`](../../lib/actions/settings.ts#L63)
- [`lib/gdpr/soft-delete.ts:68`](../../lib/gdpr/soft-delete.ts#L68)
- [`lib/gdpr/soft-delete.ts:238`](../../lib/gdpr/soft-delete.ts#L238)
- [`lib/gdpr/anonymize.ts:80`](../../lib/gdpr/anonymize.ts#L80)
- [`lib/actions/bulk-delete.ts:276`](../../lib/actions/bulk-delete.ts#L276)
...
- `/api/*` route handling now lives in [`proxy.ts:111`](../../proxy.ts#L111). This finding is retained as historical context because the remediation update below changed the API-auth model.
...
- `proxy.ts` now treats `/api/*` as authenticated by default instead of public by default.
...
- [`proxy.ts`](../../proxy.ts)
- [`__tests__/unit/middleware-api-auth.test.ts`](../../__tests__/unit/middleware-api-auth.test.ts)
- [`__tests__/unit/middleware-health-rate-limit.test.ts`](../../__tests__/unit/middleware-health-rate-limit.test.ts)
- [`__tests__/unit/middleware-body-limit.test.ts`](../../__tests__/unit/middleware-body-limit.test.ts)
