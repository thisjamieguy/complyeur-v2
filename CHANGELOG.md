...
This changelog is behind the codebase. Changes merged since 2026-04-14 — including
the engineering hardening sprint (2026-06-15) and onboarding/checkout/MFA fixes —
are recorded in git history and in `docs/audits/`, and have not yet been folded
into dated entries below. Run `pnpm changelog` to list commits since the last tag.
